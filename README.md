...
=== Squarespace to Magento 2.x Migration Tool ===
Version: 2.4.1
Developed by: LitExtension
Download: https://litextension.com/magento-2-x-migration/squarespace-to-magento-2-migration.html 


== Description ==
LitExtension Squarespace to Magento 2.x Migration Tool allows you to migrate your products, orders, customers, passwords and other data from Squarespace to Magento 2.x automatically.
